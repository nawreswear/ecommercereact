        ...
        {/* <div className="col-md-4" >
            ...
            <table class="table table-sm table-secondary">
                ...
                <tbody>
                    ...
                    <td>{client.tel}</td>
                    <td><center><Link exact to={`/EditClient/${client.id}`} className="btn btn-primary">Modifier</Link>
                    <button onClick={()=>{props.deleteuser(client.id)}} className="btn btn-danger">Supprimer</button></center></td>
                    </tr>
